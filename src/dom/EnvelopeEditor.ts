...
<div id="controls">
  <section>
    <h2>Attack</h2>
    <canvas id="attackPreview" width="100" height="100"></canvas>
  ...
  <section>
    <h2>Decay</h2>
    <canvas id="decayPreview" width="100" height="100"></canvas>
  ...
  <section>
    <h2>Sustain</h2>
    <canvas id="sustainPreview" width="100" height="100"></canvas>
  ...
  <section>
    <h2>Release</h2>
    <canvas id="releasePreview" width="100" height="100"></canvas>
