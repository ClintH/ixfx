 ...
 */
export const rawNumericRange = function* (interval: number, start: number = 0, end?: number, repeating?: boolean) {
 ...
 */
export const numericRange = function* (interval: number, start: number = 0, end?: number, rounding?: number, repeating?: boolean) {
  if (interval <= 0) throw Error(`Interval is expected to be above zero`);
