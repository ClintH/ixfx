 ...
 * @param opts 
 */
export const rect = (ctx:CanvasRenderingContext2D, toDraw:Rects.RectPositioned|readonly Rects.RectPositioned[], opts:DrawingOpts & {readonly filled?:boolean, readonly stroked?:boolean} = {}) => {
  applyOpts(ctx, opts);
