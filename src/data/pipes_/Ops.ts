...
// export type OnePipeOp<In, Out> = { _type: `One` } & ((input: IReadable<In>) => IReadable<Out>);
// export type OneToManyOp<In, Out> = { _type: `OneToMany` } & ((input: IReadable<In>) => Array<IReadable<Out>>);
// export type ManyToOneOp<In, Out> = { _type: `ManyToOne` } & ((input: Array<IReadable<In>>) => IReadable<Out>);
...
// //   const run = (upstream: IReadable<V>) => {
...
// //   const run = (upstream: IReadable<In>) => {
...
// //   const run: OnePipeOp<In, Array<In>> = (upstream: IReadable<In>) => {
...
// //   const run: OneToManyOp<V, V> = (upstream: IReadable<V>) => {
...
// //   const run: OnePipeOp<Array<V>, V> = (upstream: IReadable<Array<V>>) => {
// //     const pipe = bidi<V>();
...
// //   const run: OnePipeOp<number, MinMaxAvgTotal> = (upstream: IReadable<number>) => {
...
// //   const run: ManyToOneOp<V, Array<V>> = (upstreams: Array<IReadable<V>>) => {
