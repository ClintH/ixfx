...
test(`normalise`, () => {
  expect(Points.normalise(100, 100, 100, 100)).toEqual({x:1, y:1});
  expect(Points.normalise(0, 0, 100, 100)).toEqual({x:0, y:0});
  expect(Points.normalise(50, 50, 100, 100)).toEqual({x:0.5, y:0.5});

  expect(Points.normalise(200, 50, 100, 100)).toEqual({x:2, y:0.5});
  expect(Points.normalise(50, 200, 100, 100)).toEqual({x:0.5, y:2});

  expect(Points.normalise({x:100, y:100}, 100, 100)).toEqual({x:1, y:1});
  expect(Points.normalise({x:0, y:0}, 100, 100)).toEqual({x:0, y:0});
  expect(Points.normalise({x:50, y:50}, 100, 100)).toEqual({x:0.5, y:0.5});
