...
describe(`geometry/arc`, () => {
  ...
  describe(`fromDegrees()`, () => {
    ...
    it(`creates positioned arc from degrees`, () => {
  ...
  describe(`guard()`, () => {
    ...
    it(`throws for NaN radius`, () => {
      const arc = { radius: Number.NaN, startRadian: 0, endRadian: 1, clockwise: true };
    ...
    it(`throws for NaN startRadian`, () => {
      const arc = { radius: 10, startRadian: Number.NaN, endRadian: 1, clockwise: true };
      expect(() => Arc.guard(arc)).toThrow(`Arc endRadian is NaN`);
    });

    it(`throws for NaN endRadian`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Number.NaN, clockwise: true };
      expect(() => Arc.guard(arc)).toThrow(`Arc endRadian is NaN`);
    });
  });

  describe(`point()`, () => {
    it(`calculates point on arc`, () => {
    ...
    it(`calculates point with custom origin`, () => {
  ...
  describe(`getStartEnd()`, () => {
    ...
    it(`returns start and end with custom origin`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI / 2, clockwise: true };
  ...
  describe(`interpolate()`, () => {
    ...
    it(`throws for negative amount without overflow`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI, clockwise: true, x: 0, y: 0 };
      expect(() => Arc.interpolate(-0.1, arc)).toThrow(`under zero`);
    });

    it(`throws for amount > 1 without overflow`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI, clockwise: true, x: 0, y: 0 };
      expect(() => Arc.interpolate(1.1, arc)).toThrow(`above 1`);
    });

    it(`allows overflow when specified`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI, clockwise: true, x: 0, y: 0 };
  ...
  describe(`angularSize()`, () => {
    ...
    const east = 0;
    const south = Math.PI * 3 / 2;
    const west = Math.PI;
    it(`clockwise`, () => {
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: north, clockwise: true }, `cw`))).toEqual(-270);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: south, clockwise: true }, `cw`))).toEqual(-90);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: west, clockwise: true }, `cw`))).toEqual(-180);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: east, clockwise: true }, `cw`))).toEqual(0);

      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: west, clockwise: true }, `cw`))).toEqual(-90);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: north, clockwise: true }, `cw`))).toEqual(-180);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: east, clockwise: true }, `cw`))).toEqual(-270);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: south, clockwise: true }, `cw`))).toEqual(0);
    });

    it(`counter-clockwise`, () => {
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: north, clockwise: true }, `ccw`))).toEqual(90);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: south, clockwise: true }, `ccw`))).toEqual(270);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: west, clockwise: true }, `ccw`))).toEqual(180);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: east, endRadian: east, clockwise: true }, `ccw`))).toEqual(0);

      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: west, clockwise: true }, `ccw`))).toEqual(270);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: north, clockwise: true }, `ccw`))).toEqual(180);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: east, clockwise: true }, `ccw`))).toEqual(90);
      expect(radianToDegree(Arc.angularSize({ radius: 10, startRadian: south, endRadian: south, clockwise: true }, `ccw`))).toEqual(0);
    });

    it(`calculates angular size for counter-clockwise arc`, () => {
  ...
  describe(`fromCircleAmount()`, () => {
    it(`creates arc from circle with size`, () => {
      const circle = { x: 0, y: 0, radius: 10 };
  ...
  describe(`toLine()`, () => {
    it(`creates line from arc endpoints`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI / 2, clockwise: true, x: 0, y: 0 };
  ...
  describe(`bbox()`, () => {
    it(`calculates bounding box for positioned arc`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI / 2, clockwise: true, x: 0, y: 0 };
    ...
    it(`calculates bounding box for non-positioned arc`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI / 2, clockwise: true };
  ...
  describe(`toSvg()`, () => {
    it(`generates SVG path for positioned arc`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI / 2, clockwise: true, x: 0, y: 0 };
    ...
    it(`generates SVG path with custom origin`, () => {
      const arc = { radius: 10, startRadian: 0, endRadian: Math.PI / 2, clockwise: true };
    ...
    it(`generates SVG path from point params`, () => {
  ...
  describe(`distanceCenter()`, () => {
    it(`calculates distance between arc centers`, () => {
  ...
  describe(`isEqual()`, () => {
    it(`returns true for equal arcs`, () => {
    ...
    it(`returns false for different clockwise`, () => {
      const arc1 = { radius: 10, startRadian: 0, endRadian: 1, clockwise: true };
    ...
    it(`returns false for positioned vs non-positioned`, () => {
