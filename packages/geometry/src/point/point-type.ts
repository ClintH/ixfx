...
export const Placeholder: Point = Object.freeze({ x: Number.NaN, y: Number.NaN });
 ...
 */
export const Placeholder3d: Point3d = Object.freeze({ x: Number.NaN, y: Number.NaN, z: Number.NaN });