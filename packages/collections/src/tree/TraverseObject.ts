import { toStringAbbreviate } from '@ixfxfun/core/text';

import { last } from '@ixfxfun/iterables/sync';
import * as TreeArrayBacked from './TreeMutable.js';
import { isPrimitive } from '@ixfxfun/core'; //'../../util/IsPrimitive.js';
import type { TraversableTree, TreeNode, SimplifiedNode } from './Types.js';
import { throwNullUndef } from '@ixfxfun/guards' //'../../util/GuardEmpty.js';
