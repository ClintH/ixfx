 ...
 * @returns
 */
export function randomIndex<V>(array: ArrayLike<V>, rand: RandomSource = Math.random): number {
 ...
 * @returns
 */
export function randomElement<V>(array: ArrayLike<V>, rand: RandomSource = Math.random): V {
 ...
 * @param randomSource
 */
export function randomElementWeightedSource<V>(array: ArrayLike<V>, weightings: number[], randomSource: RandomSource = Math.random) {
 ...
 */
export function shuffle<V>(dataToShuffle: readonly V[], rand: RandomSource = Math.random): V[] {
