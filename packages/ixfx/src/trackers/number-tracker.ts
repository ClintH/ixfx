import { PrimitiveTracker, type TimestampedPrimitive, type TrackedValueOpts, type TrimReason } from "@ixfxfun/core/trackers";

import { minFast, maxFast, totalFast } from "@ixfxfun/numbers";
