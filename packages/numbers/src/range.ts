 ...
 */
export function rangeIsEqual(a: NumericRange | undefined, b: NumericRange | undefined): boolean {
 ...
 */
export function rangeIsWithin(a: NumericRange | undefined, b: NumericRange | undefined, exclusive: boolean = false): boolean {
  if (typeof a === `undefined`)
    return false;
  if (typeof b === `undefined`)
    return false;
 ...
 * @returns RangeStream
 */
export function rangeStream(initWith: NumericRange = rangeInit()): RangeStream {
