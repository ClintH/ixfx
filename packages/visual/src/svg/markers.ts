...
export function createMarker(id: string, opts: MarkerOpts, childCreator?: () => SVGElement): SVGMarkerElement {
...
export function markerPrebuilt(elem: SVGElement | null, opts: MarkerOpts, _context: DrawingOpts): string {
  if (elem === null)
    return `(elem null)`;
