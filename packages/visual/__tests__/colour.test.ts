...
describe(`colour`, () => {
  ...
  test(`colour-parse`, () => {
    ...
    expect(Colour.toHsl(`hsl(100, 100%, 50%)`)).toEqual({ h: 100 / 360, s: 1, l: 0.5, opacity: 1, space: "hsl", unit: "relative" });

    expect(Colour.toHsl(`red`)).toEqual({ h: 0, s: 1, l: 0.5, opacity: 1, space: "hsl", unit: "relative" });
    expect(Colour.toHsl(`rgb(255,0,0)`)).toEqual({ h: 0, s: 1, l: 0.5, opacity: 1, space: "hsl", unit: "relative" });
    expect(Colour.toHsl(`rgba(255,0,0, 1)`)).toEqual({ h: 0, s: 1, l: 0.5, opacity: 1.0, space: "hsl", unit: "relative" });
    expect(Colour.toHsl(`rgba(255,0,0, 0.5)`)).toEqual({ h: 0, s: 1, l: 0.5, opacity: 0.5, space: "hsl", unit: "relative" });

    expect(applyToValues(Colour.toHsl(`hotpink`), v => round(3, v))).toEqual({ h: 0.916, s: 1, l: 0.705, opacity: 1, space: "hsl", unit: "relative" });
    expect(Colour.toHsl(`rgb(255,105,180)`)).toEqual({ h: 0.916666666666666666, s: 1, l: 0.7058823529411764, opacity: 1, space: "hsl", unit: "relative" });
    expect(Colour.toHsl(`rgba(255,105,180,0.5)`)).toEqual({ h: 0.9166666666666666, s: 1, l: 0.7058823529411764, opacity: 0.5, space: "hsl", unit: "relative" });

    expect(Colour.toHsl(`hsla(100, 100%, 50%, 0.20)`)).toEqual({ h: 0.2777777777777778, s: 1, l: 0.5, opacity: 0.2, space: "hsl", unit: "relative" });
