 ...
 * ```
 */
var throttle = function (callback, intervalMinMs) {
    ...
    return function () {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        elapsed = performance.now() - trigger;
                        if (!(elapsed >= intervalMinMs)) return [3 /*break*/, 3];
                        r = callback.apply(void 0, __spreadArray([elapsed], args, false));
                        if (!(typeof r === "object")) return [3 /*break*/, 2];
                        return [4 /*yield*/, r];
                    case 1:
                        _a.sent();
                        _a.label = 2;
