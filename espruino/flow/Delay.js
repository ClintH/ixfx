...
exports.delayLoop = exports.delay = void 0;
 ...
 */
var delay = function (callback, timeoutMs) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, (0, Sleep_js_1.sleep)(timeoutMs)];
            case 1:
                _c.sent();
...
function delayAnimationLoop() {
    return __asyncGenerator(this, arguments, function delayAnimationLoop_1() {
        var resolve, p, timer, callback;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    p = new Promise(function (r) { return resolve = r; });
                    timer = 0;
                    callback = function () {
                        resolve();
                        p = new Promise(function (r) { return resolve = r; });
 ...
 */
//eslint-disable-next-line func-style
function delayLoop(timeoutMs) {
    return __asyncGenerator(this, arguments, function delayLoop_1() {
        var resolve, p, timer, callback;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(timeoutMs === 0)) return [3 /*break*/, 4];
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues(delayAnimationLoop())))];
