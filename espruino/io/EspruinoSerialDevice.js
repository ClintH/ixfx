...
exports.EspruinoSerialDevice = void 0;
var Espruino_js_1 = require("./Espruino.js");
var Serial_js_1 = require("./Serial.js");
var EspruinoSerialDevice = /** @class */ (function (_super) {
    __extends(EspruinoSerialDevice, _super);
    function EspruinoSerialDevice(opts) {
        var _this = this;
        var _a;
        _this = _super.call(this, opts) || this;
        _this.evalReplyBluetooth = false;
        if (opts === undefined)
            opts = {};
        _this.evalTimeoutMs = (_a = opts.evalTimeoutMs) !== null && _a !== void 0 ? _a : 5 * 1000;
        return _this;
    }
    EspruinoSerialDevice.prototype.disconnect = function () {
     ...
     */
    EspruinoSerialDevice.prototype.writeScript = function (code) {
     ...
     * @param opts Options
     */
    EspruinoSerialDevice.prototype.eval = function (code, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, Espruino_js_1.deviceEval)(code, opts, this, "console.log", true, function (msg) {
                        _this.warn(msg);
                    })];
            });
        });
    };
    return EspruinoSerialDevice;
}(Serial_js_1.Device));
exports.EspruinoSerialDevice = EspruinoSerialDevice;
//# sourceMappingURL=EspruinoSerialDevice.js.map