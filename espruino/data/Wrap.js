...
exports.wrapRange = exports.wrap = exports.wrapInteger = void 0;
 ...
 * @returns
 */
var wrapInteger = function (v, min, max) {
    if (min === void 0) { min = 0; }
    if (max === void 0) { max = 360; }
    (0, Guards_js_1.integer)(v, undefined, "v");
    (0, Guards_js_1.integer)(min, undefined, "min");
    (0, Guards_js_1.integer)(max, undefined, "max");
    if (v === min)
        return min;
    if (v === max)
        return min; // Wraps
...
exports.wrapInteger = wrapInteger;
/**
 ...
 * @returns
 */
var wrap = function (v, min, max) {
    if (min === void 0) { min = 0; }
    if (max === void 0) { max = 1; }
    (0, Guards_js_1.number)(v, "", "min");
    (0, Guards_js_1.number)(min, "", "min");
    (0, Guards_js_1.number)(max, "", "max");
    if (v === min)
        return min;
    if (v === max)
        return min; // Wraps
 ...
 * @returns
 */
var wrapRange = function (min, max, fn, a, b) {
    //eslint-disable-next-line functional/no-let
    var r = 0;
    // No wrapping
    var distF = Math.abs(b - a);
    // When b is wrapped forwards
    var distFwrap = Math.abs(max - a + b);
    // When b is wrapped backwards (10, 300)
    var distBWrap = Math.abs(a + (360 - b));
    var distMin = Math.min(distF, distFwrap, distBWrap);
    ...
    return (0, exports.wrapInteger)(r, min, max);
};
