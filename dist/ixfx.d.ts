 ...
 * @returns {DomLog}
 */
declare const domLog: (domQueryOrEl: HTMLElement | string, opts?: DomLogOpts) => DomLog;
...
type index_DomLogOpts = DomLogOpts;
type index_DomLog = DomLog;
declare const index_domLog: typeof domLog;
declare namespace index {
  export {
    ...
    index_DomLogOpts as DomLogOpts,
    index_DomLog as DomLog,
    index_domLog as domLog,
  };
}

export { Bezier as Beziers, CompoundPath$1 as Compound, index as Dom, Drawing, Easing$1 as Easings, Envelope as Envelopes, FrequencyHistogramPlot, Grid$1 as Grids, Line$1 as Lines, Lists, Path$1 as Paths, Plot, Point$1 as Points, Generators as Producers, Rect$1 as Rects, Set as Sets };
