...
const dataSets = {
  ...
  "diff":[[24,173],[26,170],[24,166],[27,162],[37,161],[45,157],[48,152],[46,143],[40,140],[34,137],[26,134],[24,130],[24,125],[28,121],[36,118],[46,117],[63,121],[76,125],[82,120],[86,111],[88,103],[90,91],[95,87],[107,89],[107,104],[106,117],[109,129],[119,131],[131,131],[139,134],[138,143],[131,152],[119,154],[111,149],[105,143],[91,139],[80,142],[81,152],[76,163],[67,161],[59,149],[63,138]] 
};

const ingestPoints = (points) => {
...
const draw = () => {
  ...
  // Original points
  const pts = ingestPoints(dataSets.Simple);
  Drawing.connectedPoints(ctx, pts, { 
    strokeStyle:`black`, lineWidth:4 });

  // Simplified
  const pts2 = CurveSimplification.rdpPerpendicularDistance(pts, 11);
  Drawing.connectedPoints(ctx, pts2, { strokeStyle: `yellow`, lineWidth:2});
